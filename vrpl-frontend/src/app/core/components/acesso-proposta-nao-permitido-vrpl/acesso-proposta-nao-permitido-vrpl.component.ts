...
@Component({
  selector: 'app-acesso-proposta-nao-permitido-vrpl',
  templateUrl: './acesso-proposta-nao-permitido-vrpl.component.html',
  styleUrls: ['./acesso-proposta-nao-permitido-vrpl.component.css']
})
export class AcessoPropostaNaoPermitidoVrplComponent extends BaseComponent {
