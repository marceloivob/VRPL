...
@Component({
  selector: 'vrpl-proposta-sem-dados-importados',
  templateUrl: './proposta-sem-dados-importados.component.html'
})
export class PropostaSemDadosImportadosComponent extends BaseComponent {
