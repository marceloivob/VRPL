...
@Component({
  selector: 'vrpl-nao-existe-spa-homologado',
  templateUrl: './nao-existe-spa-homologado.component.html'
})
export class NaoExisteSPAHomologadoComponent extends BaseComponent {
