...
public enum SituacaoLicitacaoEnum {
	 ...
	 */
	EM_PREENCHIMENTO("EPE", "Em Preenchimento - Fase de Licitação"),
	 ...
	 */
	EM_COMPLEMENTACAO_CONVENENTE("EMC", "Em Complementação pelo Convenente"),
	 ...
	 * <p>
	 * <b>Usado quando ainda não foi realizada a associação entre com uma Licitação
	 * e está exibindo a situação da Fase de Análise</b>
	 */
	HOMOLOGADA_NO_PROJETO_BASICO("HOM", "SPA Homologada - Fase de Análise"),
	 ...
	 * e está exibindo a situação da Fase de Análise</b>
	 */
	HOMOLOGADA_AUTOMATICAMENTE_PELO_SISTEMA_NO_PROJETO_BASICO("HAS",
			"SPA Concluída Automaticamente pelo Sistema - Fase de Análise");
