...
public class UsuarioPodeRejeitarDocumentacaoRules extends UsuarioPodeRealizarAcaoRules {
	@Inject
	...
	public boolean usuarioTemPermissaoParaExecutarAcao(PropostaBD propostaAtual, LicitacaoBD licitacao,
		...
		Boolean podeRejeitarDocumentacao = ehVersaoAtual;
		podeRejeitarDocumentacao = podeRejeitarDocumentacao && estaEmAnalise;
		podeRejeitarDocumentacao = podeRejeitarDocumentacao
				&& usuarioTemPerfilMandatariaOuConcedente(propostaAtual, usuarioLogado);

		return podeRejeitarDocumentacao;
	}
}
