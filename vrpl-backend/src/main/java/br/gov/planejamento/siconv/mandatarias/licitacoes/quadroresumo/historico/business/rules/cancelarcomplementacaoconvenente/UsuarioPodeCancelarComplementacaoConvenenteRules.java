package br.gov.planejamento.siconv.mandatarias.licitacoes.quadroresumo.historico.business.rules.cancelarcomplementacaoconvenente;
...
public class UsuarioPodeCancelarComplementacaoConvenenteRules extends UsuarioPodeRealizarAcaoRules {
	...
	public boolean usuarioTemPermissaoParaExecutarAcao(PropostaBD propostaAtual, LicitacaoBD licitacao,
		...
		Boolean estaSolicitadaComplementacao = SituacaoLicitacaoEnum.SOLICITADA_COMPLEMENTACAO.getSigla()
				.equals(licitacao.getSituacaoDaLicitacao());

		Boolean podeCancelarSolicitacaoDeComplementacao = ehVersaoAtual && estaSolicitadaComplementacao
				&& usuarioTemPerfilMandatariaOuConcedente(propostaAtual, usuarioLogado);

		return podeCancelarSolicitacaoDeComplementacao;
	}
}
