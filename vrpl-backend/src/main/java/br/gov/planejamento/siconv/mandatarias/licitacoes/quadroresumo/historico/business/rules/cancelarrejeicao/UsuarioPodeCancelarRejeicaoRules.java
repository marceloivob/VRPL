...
public class UsuarioPodeCancelarRejeicaoRules extends UsuarioPodeRealizarAcaoRules {
	...
	public boolean usuarioTemPermissaoParaExecutarAcao(PropostaBD propostaAtual, LicitacaoBD licitacao,
		...
		Boolean estaRejeitada = SituacaoLicitacaoEnum.REJEITADA.getSigla().equals(licitacao.getSituacaoDaLicitacao());

		Boolean podeCancelarRejeicao = ehVersaoAtual && estaRejeitada
				&& usuarioTemPerfilMandatariaOuConcedente(propostaAtual, usuarioLogado);

		return podeCancelarRejeicao;
	}
}
